...
const sizeStyles: Record<ButtonSize, string> = {
  sm: "text-sm font-medium sm:px-[25px] sm:py-[5px]",
  md: "text-base font-medium sm:px-[25px] sm:py-[5px] md:px-[30px] md:py-[6px]",
  lg: "text-lg font-medium sm:px-[25px] sm:py-[5px] md:px-[30px] md:py-[6px] lg:px-[40px] lg:py-[6px]",
  xl: "text-xl font-medium sm:px-[25px] sm:py-[5px] md:px-[30px] md:py-[6px] lg:px-[40px] lg:py-[6px] xl:px-[50px] xl:py-[8px]",
};
